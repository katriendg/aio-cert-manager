...
# On Disk:
# - creates a local self signed CA cert root, key and chain - secondary root
# On the cluster:
#  - updates trust configmaps and cert secret for AIO with new cert
#  - calls cmctl CLI to renew the TLS certs using the new secret
#  - restarts the OPC UA deployment to trigger reload of trust bundle
# ================================================================== #
