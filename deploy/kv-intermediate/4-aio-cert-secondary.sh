...
#  - ./deploy/kv-intermediate/2-aio-init.sh which is using trust-manager
#  - ./deploy/kv-intermediate/3-aio-deploy.sh which deploys AIO extensions, Broker, skipping OPC UA due to temporary bug
# 
